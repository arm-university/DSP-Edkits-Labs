% STM32F7_BAR_COMPLEX.M
% 
%
% MATLAB function to read complex values saved from STM32F7
% memory using Keil uvision 5 and plot as bar graphs
% data should be 32-bit floating point saved in
% Intel hex format file
%

function stm32f7_bar_complex()
